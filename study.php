    ...
    <div class="container-fluid sider pb-5 mt-0" style="background-color: #212529;">
        <div id="content py-5">
            <div id="horz-list">
              <ul class="py-5" style="font-family: 'Century Gothic', sans-serif;">
                ...
                <li><a href="study.php" class="kitchen">Study Unit</a></li>
        ...
        <div class="row">
            ...
            <div class="card gallery-card my-3" style="height:300px;">
                <div class="card-img">
                    <a href="#"><img id="myImg" src="images/s.jpg" style="width:100%; height:250px;"></a>
                </div>
                <div class="card-body">
        ...
        <div class="col-sm-12 col-md-6 col-xl-3 col-lg-3" data-aos="fade-up" data-aos-delay="200">
            <div class="card gallery-card my-3" style="height:300px;">
                <div class="card-img">
                    <a href="#"><img id="myImg1" src="images/st-1.jpg" style="width:100%; height:250px;"></a>
                </div>
                <div class="card-body">
                    <h5 class="card-title gallery-title1">header-area</h5>
                    <h6 class="card-text2">Some text here...</h6>
        ...
        <div class="col-sm-12 col-md-6 col-xl-3 col-lg-3" data-aos="fade-up" data-aos-delay="300">
            <div class="card gallery-card my-3" style="height:300px;">
                <div class="card-img">
                    <a href="#"><img id="myImg2" src="images/st-2.jpg" style="width:100%; height:250px;"></a>
                </div>
                <div class="card-body">
                    <h5 class="card-title gallery-title1">header-area</h5>
                    <h6 class="card-text2">Some text here...</h6>
        ...
        <div class="col-sm-12 col-md-6 col-xl-3 col-lg-3" data-aos="fade-up" data-aos-delay="500">
            <div class="card gallery-card my-3" style="height:300px;">
                <div class="card-img">
                    <a href="#"><img id="myImg3" src="images/st.jpg" style="width:100%; height:250px;"></a>
                </div>
                <div class="card-body">
                    <h5 class="card-title gallery-title1">header-area</h5>
                    <h6 class="card-text2">Some text here...</h6>
